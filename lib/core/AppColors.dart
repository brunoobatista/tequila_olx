...
class AppColors {
  ...
  static final Color pPurpleLight = Color(0xFFd05ce3);
  static final Color pPurpleDark = Color(0xFF6a0080);

  // static final Color pPurple = Color(0xFF3A2835);
  // static final Color pPurpleLight = Color(0xFF51384A);
  // static final Color pPurpleDark = Color(0xFF51384A);

  // colors secondary
  static final Color sDeepPurple = Color(0xFF7e57c2);
  static final Color sDeepPurpleLight = Color(0xFFb085f5);
  static final Color sDeepPurpleDark = Color(0xFF4d2c91);

  // colors text
  static final Color pText = Color(0xFFffffff);
  static final Color sText = Color(0xFFffffff);
  static final Color backGroundGrey = Color(0xfff5f5f5);
  static final Color backGroundGreyAcent = Color(0xffbdbdbd);
